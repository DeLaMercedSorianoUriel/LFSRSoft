...
function ProductoImg({ id, categoria, producto }) {
  ...
  if (!src) {
    return (
      <div style={{ width:'100%', height:'180px', background: COLORES[categoria] || '#1e40af',
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>LFSRSoft — Tienda de Licencias Digitales</title>
        ...
        <div style={{ display:'flex', gap:'0.75rem', alignItems:'center' }}>
          <button onClick={verPedidos}
            style={{ background:'transparent', border:'1px solid #334155',
              color:'#94a3b8', padding:'0.4rem 0.9rem', borderRadius:'6px',
      ...
      <div style={{ position:'relative', height:'260px', overflow:'hidden',
        ...
        <div style={{ position:'absolute', inset:0, display:'flex',
          ...
          <h1 style={{ fontSize:'2.25rem', fontWeight:900, letterSpacing:'-0.5px',
            marginBottom:'0.5rem' }}>
            Software Profesional y Licencias Digitales
          </h1>
                ...
                <div key={p.id}
                  ...
                  <div style={{ padding:'0.9rem' }}>
                    ...
                    <div style={{ fontSize:'0.68rem', color:'#64748b',
                      ...
                      borderRadius:'3px', marginBottom:'0.6rem',
                      fontWeight:500 }}>
                      {p.tipo_licencia}
                    </div>
        ...
        <div style={{ maxWidth:'1400px', margin:'0 auto',
          ...
          <div>
            <div style={{ color:'#f8fafc', fontWeight:700, fontSize:'0.85rem',
              ...
              letterSpacing:'0.5px' }}>Categorias</div>
          ...
          <div>
            <div style={{ color:'#f8fafc', fontWeight:700, fontSize:'0.85rem',
              marginBottom:'0.5rem', textTransform:'uppercase',
              letterSpacing:'0.5px' }}>Informacion</div>
            ...
            <div style={{ padding:'1.25rem' }}>
              ...
              <div style={{ background:'#f8fafc', borderRadius:'6px',
                ...
                <div style={{ fontSize:'0.72rem', color:'#94a3b8',
                  ...
                  letterSpacing:'0.5px', marginBottom:'0.15rem' }}>
                  Tipo de licencia
                </div>
            ...
            <div style={{ padding:'1rem 1.25rem', borderBottom:'1px solid #e2e8f0',
              ...
              <button onClick={()=>setCarritoOpen(false)}
                style={{ background:'transparent', border:'none',
                  color:'#94a3b8', fontSize:'1.4rem', lineHeight:1 }}>x</button>
            </div>
        ...
        <div style={{ position:'fixed', inset:0, background:'rgba(0,0,0,0.6)',
          ...
          <div style={{ background:'white', borderRadius:'10px',
            ...
            <div style={{ background:'#15803d', color:'white',
              padding:'1.25rem 1.5rem', borderRadius:'10px 10px 0 0',
              textAlign:'center' }}>
              <div style={{ fontWeight:900, fontSize:'1.25rem',
                marginBottom:'0.25rem' }}>Pedido completado</div>
            ...
            <div style={{ padding:'1.25rem' }}>
              ...
              <div style={{ display:'flex', justifyContent:'space-between',
                padding:'0.6rem 0', borderTop:'1px solid #f1f5f9',
                marginTop:'0.4rem' }}>
                <span style={{ fontWeight:600, color:'#64748b',
                  fontSize:'0.85rem' }}>Total pagado</span>
          ...
          <div style={{ position:'absolute', right:0, top:0, bottom:0,
            ...
            <div style={{ padding:'1rem 1.25rem', borderBottom:'1px solid #e2e8f0',
              ...
              <button onClick={()=>setPedidosOpen(false)}
                style={{ background:'transparent', border:'none',
                  color:'#94a3b8', fontSize:'1.4rem' }}>x</button>
            </div>
